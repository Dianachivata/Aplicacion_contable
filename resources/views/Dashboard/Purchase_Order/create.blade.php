...
<div class="container py-4">
    <h1 class="mb-4">Agregar Orden de compra</h1>
    <form action="{{route('purchase_order.store')}}" method="post">
        @csrf 
        <div class="form-group row">
            <label for="Code" class="col-sm-2 col-form-label">Codigo</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="Code" id="Code" placeholder="Ingrese el codigo">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="Sale_Price" id="Sale_Price" placeholder="Ingrese el precio">
            </div>
        </div>
        <div class="form-group row">
